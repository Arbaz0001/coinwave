...
export default function SellUSDT() {
  ...
  const handleSell = () => {
    ...
    alert(`Selling ${parsed} USDT to ${getWalletType(selectedWallet)}`);
  };
      ...
      {showAccountsPage ? (
        <>
          ...
          <button
            ...
            className="w-full py-3 border-2 border-dashed border-blue-400 text-blue-600 rounded-md mb-4"
          >
            + Add new account
          </button>
        ...
        <>
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-xl font-semibold text-gray-800">Sell USDT</h1>
            <button
          ...
          <div className="border rounded-lg p-4 mb-4">
            ...
            {wallets.length === 0 ? (
              <button
                onClick={() => setShowBindForm(true)}
                className="w-full py-3 border-2 border-dashed border-blue-400 text-blue-600 rounded-md flex justify-center items-center gap-2"
              >
                + Add wallet address
              </button>
            ) : (
          ...
          {/* Amount Section */}
          <div className="border rounded-lg p-4 mb-4">
            <h2 className="font-medium text-gray-700 mb-2">Sell amount</h2>
            <input
              type="number"
              min="0"
