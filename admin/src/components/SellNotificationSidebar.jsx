...
export default function SellNotificationSidebar({ users, selectedId, onSelect, collapsed, onToggle, multiSelect = false, selectedIds = [], onToggleUser }) {
  return (
    <>
      ...
      } md:block w-full max-h-[70vh] md:max-h-screen md:w-80 bg-gradient-to-b from-slate-800 to-slate-900 text-white md:border-r border-slate-700 overflow-hidden flex flex-col`}>
        {/* Header */}
